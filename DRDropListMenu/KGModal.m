...
- (void)showWithContentView:(UIView *)contentView andAnimated:(BOOL)animated{
    ...
    KGModalCloseButton *closeButton = self.closeButton = [[KGModalCloseButton alloc] initWithFrame:(CGRect){CGRectGetMaxX(contentView.frame) - 16,0,32,32}];
...
- (id)initWithFrame:(CGRect)frame{
    ...
    styleLayer.shadowColor= [[UIColor yellowColor] CGColor];
    ...
    styleLayer.backgroundColor = [[UIColor colorWithRed:0.8 green:0.5 blue:0.1 alpha:0.7] CGColor];//modify the background color
